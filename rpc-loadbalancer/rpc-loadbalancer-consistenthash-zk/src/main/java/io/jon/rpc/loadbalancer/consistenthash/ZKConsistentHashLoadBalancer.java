...
@SPIClass
public class ZKConsistentHashLoadBalancer implements
        ServiceLoadBalancer<ServiceInstance<ServiceMeta>> {
    ...
    @Override
    public ServiceInstance<ServiceMeta> select(
        ...
        TreeMap<Integer, ServiceInstance<ServiceMeta>> ring =
                makeConsistentHashRing(servers);
    ...
    private ServiceInstance<ServiceMeta> allocateNode(TreeMap<Integer, ServiceInstance<ServiceMeta>> ring, int hashCode) {
        ...
        if(entry == null){
            throw new RuntimeException("do not discover useful service, " +
                    "please register service in registry center.");
        }
