...
public final class ExtensionLoader<T> {
    ...
    private static final String JON_DIRECTORY = "META-INF/jon/";
    private static final String JON_DIRECTORY_EXTERNAL = "META-INF/jon/external/";
    private static final String JON_DIRECTORY_INTERNAL = "META-INF/jon/internal/";

    private static final String[] SPI_DIRECTORIES = new String[]{
            SERVICES_DIRECTORY,
            JON_DIRECTORY,
            JON_DIRECTORY_EXTERNAL,
            JON_DIRECTORY_INTERNAL
    };
