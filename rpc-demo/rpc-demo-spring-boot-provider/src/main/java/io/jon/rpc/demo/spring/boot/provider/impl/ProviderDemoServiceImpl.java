package io.jon.rpc.demo.spring.boot.provider.impl;
...
@RpcService(interfaceClass = DemoService.class, interfaceClassName = "io.jon.rpc.demo.api.DemoService", version = "1.0.0", group = "jon", weight = 2)
